...
const manualChangelogEntries: ChangelogEntry[] = [
	{
		...
		title: "首页入场稳定与全宽对话",
		summary:
			"首帧预留滚动条空间，拼图完成后不再缩放，并让对话框更早以全宽底栏出现。",
		changes: [
	...
	},
	{
		...
		type: "fix",
		title: "首页影像轮播控制与进度修复",
		summary: "修复分段进度断格，并加入可循环切换的上一张、下一张控制。",
		changes: [
			"将并发延迟动画改为逐格串行推进，避免暂停或切页后出现中间漏亮。",
			"在影像舞台左右加入黑框白底切换按钮，支持首尾循环浏览五幕画面。",
			"手动切换会重置当前幕进度并继续自动播放，键盘聚焦时仍会暂停轮播。",
			"缩短画面位移与淡化时长，并使用合成层过渡减少快速连点时的顿挫。",
		],
	},
	{
		version: "v6.14.55",
	...
	},
	{
		...
		title: "首页入场分镜顺序优化",
		summary:
			"移除拼图阶段的重复品牌字，并将封面、时间、主字标与对话框改为顺序揭示。",
		changes: [
			"删除拼图前与拼合后的两套临时文字，入场过程只保留壁纸切片和完整封面。",
			"统一首页揭示时间线，按封面、时间、手写 JingYue 字标、对话框的顺序自动播放。",
			"移除切片模糊计算，只动画合成层属性，并将拼图节点清理延后到浏览器空闲阶段。",
			"同步适配手机端与减少动态效果偏好，避免初始内容抢先显示或对话框提前弹出。",
		],
	},
	{
		version: "v6.14.52",
